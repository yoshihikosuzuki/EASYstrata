...
keep0 <- read.table(argv[2]) #table of subscaffold with three columns : 
                             #number of gene in the scaffold\tscaffold_haplotype1 id\tscaffold_haplotype2 id\n
                             #autogenerated by the script 11_run_GeneSpace_paml_ideogram.sh
base <- basename(paf)
